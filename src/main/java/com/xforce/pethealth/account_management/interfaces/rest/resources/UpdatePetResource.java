...
public record UpdatePetResource (Long petOwnerId, Long petId, String name, String specie, int age, String sex, String size, double weight, double perimeter, String image) {
